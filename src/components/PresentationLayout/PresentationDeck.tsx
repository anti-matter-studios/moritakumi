...
import { ResponsiveSlideSplitProvider } from "./responsiveSlideSplitting";
...
export default function PresentationDeck(props: PresentationDeckProps) {
    ...
    return <ResponsiveSlideSplitProvider>
        <main ref={deckRef} className={className} id="presentation">
            {props.children}
            <button
                type="button"
